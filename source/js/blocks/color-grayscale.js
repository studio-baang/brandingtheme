...
(function(blocks, element, blockEditor) {
    ...
    registerBlockType("studio-baang/color-gradient", {
        ...
        category: "design",
        icon: "lightbulb",
        description: "브랜드 컬러 칩을 생성합니다. hex값을 선택하면 자동으로 rgb, cmyk값을 반환합니다.",
        attributes: {
            name: {
                type: "string"
            },
...
function ChipTitle(props) {
    ...
    return name != null ? el("h2", {
        class: "color-chip__title"
    }, `${name}`) : "";
}
function ChipDataList(props) {
    const hex = props.color;
    const { r , g , b  } = (0, _convertColor.HEXtoRGB)(hex);
    const { c , m , y , k  } = (0, _convertColor.HEXtoCMYK)(hex);
    return el("dl", {
        class: "color-chip__list"
    }, el("dt", {
        class: "color-chip__type"
    }, "HEX"), el("dd", {
        class: "color-chip__value"
    }, `${hex}`), el("dt", {
        class: "color-chip__type"
    }, "RGB"), el("dd", {
        class: "color-chip__value"
